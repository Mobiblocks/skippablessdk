...
//#ifdef LOCAL
//#define SKIPPABLES_API_BANNER_URL @"http://10.0.0.50/tek/banner"
//#define SKIPPABLES_API_VIDEO_URL @"http://10.0.0.50/tek/video"
//#define SKIPPABLES_INSTALL_URL @"http://10.0.0.50/tek/install"
//#else
