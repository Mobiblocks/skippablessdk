...
@interface SKIVASTJavaScriptResource ()
...
@implementation SKIVASTJavaScriptResource {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTJavaScriptResource object
*/
