...
@implementation SKIVASTCategory {
    NSLocale *_locale;
}
/**
...
- (void) readAttributes:(void*) reader {
    char* authorityAttrValue = (char*) xmlTextReaderGetAttribute(reader, (xmlChar*)"authority");
    if(authorityAttrValue) {
        NSString *authorityStringValue = [[NSString stringWithCString:authorityAttrValue encoding:NSUTF8StringEncoding] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        self.authority = [NSURL URLWithString:authorityStringValue];
        xmlFree(authorityAttrValue);
    }
}
...
* Description: Iterate through the XML and create the SKIVASTCategory object
*/
...
- (NSDictionary *)dictionary {
    ...
    if(self.authority != nil) {
        [dict setObject:self.authority forKey:@"authority"];
    }
