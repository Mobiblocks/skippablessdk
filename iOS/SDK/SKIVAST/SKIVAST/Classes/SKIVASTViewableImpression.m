...
@interface SKIVASTViewableImpression ()
...
@implementation SKIVASTViewableImpression {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTViewableImpression object
*/
