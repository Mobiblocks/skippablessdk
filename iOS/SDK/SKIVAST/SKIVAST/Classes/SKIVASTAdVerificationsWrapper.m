...
@interface SKIVASTAdVerificationsWrapper ()

@property (nonatomic, readwrite) NSMutableArray<SKIVASTVerificationWrapper *> *verifications;

@end

@implementation SKIVASTAdVerificationsWrapper {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTAdVerificationsWrapper object
*/
...
- (void)initProperties {
    ...
    self.verifications = [NSMutableArray array];
}
...
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild {
    ...
    if([@"Verification" isEqualToString:_currentElementName]) {
        
        [self.verifications addObject:[[SKIVASTVerificationWrapper alloc] initWithReader:reader]];
        *handledInChild = YES;
...
- (NSDictionary *)dictionary {
    ...
    if(self.verifications != nil) {
        NSDictionary *verificationsDict = [self.verifications valueForKeyPath:@"dictionary"];
        [dict setObject:verificationsDict forKey:@"verifications"];
    }
