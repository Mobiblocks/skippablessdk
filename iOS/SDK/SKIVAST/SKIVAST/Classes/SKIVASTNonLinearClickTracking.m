...
@interface SKIVASTNonLinearClickTracking ()
...
@implementation SKIVASTNonLinearClickTracking {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTNonLinearClickTracking object
*/
