...
@interface SKIVASTNonLinearAdBase ()

@property (nonatomic, readwrite) SKIVASTNonLinearClickTracking *nonLinearClickTracking;

@end

@implementation SKIVASTNonLinearAdBase {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTNonLinearAdBase object
*/
...
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild {
    ...
    if([@"NonLinearClickTracking" isEqualToString:_currentElementName]) {
        
        self.nonLinearClickTracking = [[SKIVASTNonLinearClickTracking alloc] initWithReader:reader];
        *handledInChild = YES;
...
- (NSDictionary *)dictionary {
    ...
    if(self.nonLinearClickTracking != nil) {
        NSDictionary *nonLinearClickTrackingDict = [self.nonLinearClickTracking valueForKeyPath:@"dictionary"];
        [dict setObject:nonLinearClickTrackingDict forKey:@"nonLinearClickTracking"];
    }
