...
@class SKIVASTIconTrackingUri;

@interface SKIVASTIconClicks : NSObject
...
*/
@property (nonatomic, readonly) NSURL *iconClickThrough;
/**
URLs to ping when user clicks on the the icon.
*/
@property (nonatomic, readonly) NSMutableArray<SKIVASTIconTrackingUri *> *iconClickTrackings;
...
@interface SKIVASTIconClicks (Reading)
