...
/**
* SKIVASTAdVerificationsWrapper.h

*/

#import <Foundation/Foundation.h>

@class SKIVASTVerificationWrapper;
...
executed for collecting data to verify ad playback details.
*/
@interface SKIVASTAdVerificationsWrapper : NSObject

- (void)initProperties;
- (void)parseWithReader:(void *) reader;
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild;

@property (nonatomic, readonly) NSMutableArray<SKIVASTVerificationWrapper *> *verifications;
...
@interface SKIVASTAdVerificationsWrapper (Reading)
