...
@interface SKIVASTIcons ()

@property (nonatomic, readwrite) SKIVASTIcon *icon;

@end

@implementation SKIVASTIcons {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTIcons object
*/
...
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild {
    ...
    if([@"Icon" isEqualToString:_currentElementName]) {
        
        self.icon = [[SKIVASTIcon alloc] initWithReader:reader];
        *handledInChild = YES;
...
- (NSDictionary *)dictionary {
    ...
    if(self.icon != nil) {
        NSDictionary *iconDict = [self.icon valueForKeyPath:@"dictionary"];
        [dict setObject:iconDict forKey:@"icon"];
    }
