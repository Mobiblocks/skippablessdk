...
/**
* SKIVASTLinearWrapperChild.h

*/

#import <Foundation/Foundation.h>
#import "SKIVASTLinearBase.h"
@class SKIVASTVideoClicksBase;
...
Video formatted ad that plays linearly
*/
@interface SKIVASTLinearWrapperChild : SKIVASTLinearBase

- (void)initProperties;
- (void)parseWithReader:(void *) reader;
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild;

@property (nonatomic, readonly) SKIVASTVideoClicksBase *videoClicks;
...
@interface SKIVASTLinearWrapperChild (Reading)
