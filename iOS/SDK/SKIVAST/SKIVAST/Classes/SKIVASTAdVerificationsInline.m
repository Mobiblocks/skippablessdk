...
@interface SKIVASTAdVerificationsInline ()

@property (nonatomic, readwrite) NSMutableArray<SKIVASTVerificationInline *> *verifications;

@end

@implementation SKIVASTAdVerificationsInline {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTAdVerificationsInline object
*/
...
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild {
    ...
    if([@"Verification" isEqualToString:_currentElementName]) {
        ...
        [self.verifications addObject:[[SKIVASTVerificationInline alloc] initWithReader:reader]];
        *handledInChild = YES;
