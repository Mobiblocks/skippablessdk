...
@interface SKIVASTCreativeExtensions ()

@property (nonatomic, readwrite) NSMutableArray<SKIVASTCreativeExtension *> *creativeExtensions;

@end

@implementation SKIVASTCreativeExtensions {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTCreativeExtensions object
*/
...
- (void)initProperties {
    ...
    self.creativeExtensions = [NSMutableArray array];
}
...
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild {
    ...
    if([@"CreativeExtension" isEqualToString:_currentElementName]) {
        
        [self.creativeExtensions addObject:[[SKIVASTCreativeExtension alloc] initWithReader:reader]];
        *handledInChild = YES;
