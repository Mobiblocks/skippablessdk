...
/**
* SKIVASTVideoClicksInlineChild.h

*/

#import <Foundation/Foundation.h>
#import "SKIVASTVideoClicksBase.h"
@class SKIVASTClickThrough;

@interface SKIVASTVideoClicksInlineChild : SKIVASTVideoClicksBase
...
*/
@property (nonatomic, readonly) SKIVASTClickThrough *clickThrough;
...
@interface SKIVASTVideoClicksInlineChild (Reading)
