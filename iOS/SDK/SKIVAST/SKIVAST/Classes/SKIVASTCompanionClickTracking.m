...
@interface SKIVASTCompanionClickTracking ()
...
@implementation SKIVASTCompanionClickTracking {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTCompanionClickTracking object
*/
