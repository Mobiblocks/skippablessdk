...
@interface SKIVASTCreatives ()

@property (nonatomic, readwrite) NSMutableArray<SKIVASTCreativeInlineChild *> *creatives;

@end

@implementation SKIVASTCreatives {
    NSLocale *_locale;
}
/**
...
* Description: Iterate through the XML and create the SKIVASTCreatives object
*/
...
- (void)handleElementName:(NSString *)_currentElementName reader:(void *) reader readerOk:(int *)_readerOk currentNodeType:(int *)_currentNodeType currentXmlDept:(int *)_currentXmlDept handledInChild:(BOOL *)handledInChild {
    ...
    if([@"Creative" isEqualToString:_currentElementName]) {
        
        [self.creatives addObject:[[SKIVASTCreativeInlineChild alloc] initWithReader:reader]];
        *handledInChild = YES;
